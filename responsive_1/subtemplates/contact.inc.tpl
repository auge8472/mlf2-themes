...
{/if}
{/if}
<p><button name="message_submit" value="{#message_submit_caption#}" onclick="document.getElementById('throbber-submit').classList.remove('js-visibility-hidden')">{#message_submit_caption#}</button> <img id="throbber-submit" class="js-visibility-hidden" src="{$THEMES_DIR}/{$theme}/images/throbber.svg" alt="" width="16" height="16" /></p>
</div>
</form>
{/if}
