...
{foreach from=$userdata item=row}
  <tr>
   ...
   <td data-header="{#user_email#}"><span class="value">{if $row.user_email}<a href="index.php?mode=contact&amp;recipient_user_id={$row.user_id}"><img src="{$THEMES_DIR}/{$theme}/images/contact-email.svg" alt="{#email#}" width="15" height="15" class="icon" /></a>{else}&nbsp;{/if}</span></td>
