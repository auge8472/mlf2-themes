...
{foreach from=$userdata item=row}
  <tr>
   <td data-header="{#user_name#}" class="cell-subject"><a href="index.php?mode=user&amp;show_user={$row.user_id}" title="{#show_userdata_linktitle#|replace:"[user]":$row.user_name}"><strong>{$row.user_name}</strong></a></td>
