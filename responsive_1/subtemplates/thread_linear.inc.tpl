...
<li><a href="index.php?mode=posting&amp;unlock_thread={$element.id}&amp;back=thread" class="unlock-thread" title="{#unlock_thread_linktitle#}">{#unlock_thread_linkname#}</a></li>{/if}{/if}
{/if}
</ul>
</footer>
</div>
