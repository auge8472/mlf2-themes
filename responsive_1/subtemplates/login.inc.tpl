...
<p><label for="password" class="main">{#login_password#}</label><br /><input id="password" class="login" type="password" spellcheck="false" autocomplete="off" name="userpw" size="25" /></p>
